...
void bind_NetworkRuntime(py::module m) {
    ...
    py::class_<NetworkRuntime>(m, "NetworkRuntime")
            .def(py::init<const Identifier&, const MessageSet&, NetworkInterface&>(),
                    py::arg("own_mavlink_id"), py::arg("message_set"), py::arg("interface"))
            .def(py::init<const MessageSet&, NetworkInterface&>(),
                    py::arg("message_set"), py::arg("interface"))
            .def(py::init<const Identifier&, const MessageSet&, const Message&, NetworkInterface&>(),
                    py::arg("own_mavlink_id"), py::arg("message_set"), py::arg("heartbeat_message"), py::arg("interface"))
            .def(py::init<const MessageSet&, const Message&, NetworkInterface&>(), py::arg("message_set"),
